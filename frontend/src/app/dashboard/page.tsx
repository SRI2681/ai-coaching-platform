...
import { startSession, startAvatarSession } from '../../lib/api';
    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='max-w-4xl mx-auto p-8'>
        <div className='bg-white rounded-2xl shadow p-6 mb-6'>
          <h2 className='text-2xl font-bold text-blue-900 mb-1'>Your Coaching Level</h2>
          <p className='text-gray-500 mb-4'>Difficulty adapts automatically as you grow.</p>
          <div className='flex items-center gap-4'>
            <div
              className={`w-16 h-16 rounded-full ${cdlColors[cdlBand]} flex items-center justify-center text-white text-2xl font-bold`}
            >
              {cdl.toFixed(1)}
            </div>
            <div>
              <p className='text-lg font-semibold text-gray-800'>
                CDL {cdl.toFixed(1)} — {cdlLabels[cdlBand]}
              </p>
              <p className='text-gray-500 text-sm'>Your coach: {coachName}</p>
            </div>
          </div>
        </div>
